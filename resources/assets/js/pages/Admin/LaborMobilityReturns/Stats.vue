  ...
  <section>
    ...
    <div class="admin-box">
      <div class="admin-box-title flex flex-wrap justify-between items-center">
        <h2 class="flex-1 text-teal font-dosis font-bold xs:mb-4 leading-none">Registros de retornos por fecha</h2>
...
export default {
  ...
  methods: {
    async load(draw = true) {
      ...
      var stats = await this.$http.get('/admin/stats/labor-mobility', {
        params
      });
