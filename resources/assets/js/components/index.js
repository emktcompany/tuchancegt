...
export default {
  install(Vue) {
    ...
    Vue.component('dialect-select', () => import(/* webpackChunkName: "dialects" */ '@/components/form/DialectSelect.vue'));
    Vue.component('ethnicity-select', () => import(/* webpackChunkName: "dialects" */ '@/components/form/EthnicitySelect.vue'));
