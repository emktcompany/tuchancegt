    ...
    ->group(function ($router) {
        ...
        $router
            ...
            ->group(function ($router) {
                ...
                $router->get('enrollments', 'EnrollmentsController@index')
                    ->name('enrollments');
                $router->get('labor-mobility', 'LaborMobilityController@index')
                    ->name('labor-mobility');
        ...
        $router
            ...
            ->group(function ($router) {
                ...
                $router->apiResource('labor-mobility-countries', 'LaborMobilityCountriesController');
                $router->apiResource('labor-mobility-people', 'LaborMobilityPeopleController');
                $router->apiResource('labor-mobility-estates', 'LaborMobilityEstatesController');
                $router->apiResource('labor-mobility-interviews', 'LaborMobilityInterviewsController');
                $router->get('labor-mobility-returns/export', 'LaborMobilityReturnsController@export')
                    ->name('labor-mobility-returns.export');
                $router->post(
                    'labor-mobility-returns/import',
                    'LaborMobilityReturnsController@import'
                )->name('labor-mobility-returns.import');
                $router->apiResource('labor-mobility-returns', 'LaborMobilityReturnsController');

                $router->apiResource('dialects', 'DialectsController');
                $router->apiResource('ethnicities', 'EthnicitiesController');
                $router->get('training-records/export', 'TrainingRecordsController@export')
                    ->name('training-records.export');
                $router->post('training-records/import', 'TrainingRecordsController@import')
                    ->name('training-records.import');
                $router->apiResource('training-records', 'TrainingRecordsController');
                $router->apiResource('training-workshops', 'TrainingWorkshopsController');
                $router->apiResource('training-people', 'TrainingPeopleController');
            });
    });
